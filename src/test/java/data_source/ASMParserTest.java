...
//	}
	...
	@Test
	void testParseTestClassForCoverage() {		
		FieldNode mf1 = EasyMock.createMock(FieldNode.class);
		mf1.name = "field1";
		mf1.desc = "I";
		mf1.access = 0;
		...
		// Actual
		EasyMock.replay(classNode, mf1, mf2, mn1, mn2, mn3, mn4, mn5, mn6, mn7, mn8, mn9, mn10, mn11, mn12, mn13, mn14, mn15, mn16, m1Mock, m2Mock);
		ArrayList<MyClassNode> myNodes = ASMParser.parseASM(nodes);
		MyClassNode parsedClass = myNodes.get(0);
		...
		EasyMock.verify(classNode, mf1, mf2, mn1, mn2, mn3, mn4, mn5, mn6, mn7, mn8, mn9, mn10, mn11, mn12, mn13, mn14, mn15, mn16, m1Mock, m2Mock);
	}
}
