...
public class NamesCheck implements SingleClassCheck {
	
	@Override
	public String runCheck(MyClassNode checkClass) {
	...
	private String checkLocal(MyLocalVariableNode checkVar, String methodName) {
		...
		String fieldDesc = checkVar.getTypeName();
	...
	protected String checkField(MyFieldNode field) {
		...
		// Type name correspond check
		String fieldDesc = field.getTypeName();
